...
export function NavBar(props: INavBarProps) {
  ...
  return (
    <section className="w-full flex justify-between items-center sticky top-0 left-0 px-5  xl:px-16 xl:py-7 h-[4.375rem] border-b border-gray-500 bg-dark-500 text-white">
      <div className="flex items-center gap-1">
        <div onClick={changeSidebar}>
          <Icon variant="menu" className="xl:hidden" />
        </div>
        <div className="flex items-center gap-1">
