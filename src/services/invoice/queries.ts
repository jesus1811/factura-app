...
export const getAllInvoicesToday = async (filter: IFilterInvoice): Promise<IInvoice[] | undefined> => {
  try {
    const { id, invoice_method_id, type, currentPage = 1, totalPerPage = 999 } = filter;
